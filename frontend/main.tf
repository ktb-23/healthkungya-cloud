...
resource "aws_s3_bucket" "storage" {
  bucket = "ktb-23-healthkungya-storage-dev"
}

locals {
  s3_origin_id                      = "ktb-23-healthkungya-storage-dev-origin-id"
  target_domain_url                 = "www.health-kungya.me.uk"
  target_domain_acm_certificate_arn = "arn:aws:acm:us-east-1:975049946739:certificate/f19b78d3-4e99-4f86-9e85-500db5873c60"
  route53_hosted_zone_id            = "Z02843292TL82PONU2ENC"
}
